...
GUARDS: Sep 7 (Labor Day, in W3) and Nov 26-27 (Thanksgiving, in W14) are OFF — send only a one-line rest note. Before Aug 26, 2026 → give the 90-minute weekend setup checklist from 00-PROGRAM.md instead. After Dec 11, 2026 → Continuous Mode; deliver a short frontier-watch or deep-dive prompt.
